...
// 舵机 PWM 控制 (GPIO48/13 → 2路舵机)
#define SERVO1_PWM_PIN GPIO_NUM_48
#define SERVO2_PWM_PIN GPIO_NUM_13
#define SERVO3_PWM_PIN GPIO_NUM_NC
#define SERVO4_PWM_PIN GPIO_NUM_NC

// 直流电机控制 (DRV8833)
//   A路 → TT马达1: AIN1=IO1, AIN2=IO2
//   B路 → TT马达2: BIN1=IO10, BIN2=IO11
#define MOTOR_A_IN1_PIN GPIO_NUM_1
#define MOTOR_A_IN2_PIN GPIO_NUM_2
#define MOTOR_B_IN1_PIN GPIO_NUM_10
#define MOTOR_B_IN2_PIN GPIO_NUM_11

// 超声波传感器 (未使用)
#define ULTRASONIC_TRIG_PIN GPIO_NUM_NC
#define ULTRASONIC_ECHO_PIN GPIO_NUM_NC
